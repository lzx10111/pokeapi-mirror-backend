...
public class AdminController {
	...
	public ResponseEntity<?> addGroup(@RequestBody @Valid PokemonGroup addGroup) {
		...
		Long total = pokemonService.saveListPokemon(addGroup.getStart(), addGroup.getEnd());
		msg.put("total", total);
	...
	public ResponseEntity<?> deleteGroup(@RequestBody @Valid PokemonGroup deleteGroup) {
		...
		HashMap<String, Long> msg = new HashMap<String, Long>();
		Long total = pokemonService.deleteListPokemon(deleteGroup.getStart(), deleteGroup.getEnd());
		msg.put("total", total);
	...
	public ResponseEntity<?> addSpecific(@RequestBody @Valid PokemonSpecific addSpecific, Locale locale) {
		List<SimpleMessage> errors = pokemonService.addSpecificHasErrors(addSpecific.getId(),
				addSpecific.getName(), "addSpecificId",
				"addSpecificName", locale);
	...
	public ResponseEntity<?> deleteSpecific(@RequestBody @Valid PokemonSpecific deleteSpecific) {
		...
		if (!deleteSpecific.getId().isEmpty()) {
